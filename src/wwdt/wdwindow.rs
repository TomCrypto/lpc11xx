#[doc = "Reader of register WDWINDOW"]
pub type R = crate::R<u32, super::WDWINDOW>;
#[doc = "Writer for register WDWINDOW"]
pub type W = crate::W<u32, super::WDWINDOW>;
#[doc = "Register WDWINDOW `reset()`'s with value 0x00ff_ffff"]
impl crate::ResetValue for super::WDWINDOW {
    type Type = u32;
    #[inline(always)]

...
impl<'a> _ABEOINTCLRW<'a> {
    ...
    pub fn noimpact(self) -> &'a mut W {
        self.variant(ABEOINTCLRW::NOIMPACT)
    }
    #[doc = "Writing a 1 will clear the corresponding interrupt in the IIR"]
    #[inline]
...
impl<'a> _ABTOINTCLRW<'a> {
    ...
    #[inline]
    pub fn noimpact(self) -> &'a mut W {
        self.variant(ABTOINTCLRW::NOIMPACT)
    }
    #[doc = "Writing a 1 will clear the corresponding interrupt in the IIR"]
    #[inline]
    pub fn clear(self) -> &'a mut W {

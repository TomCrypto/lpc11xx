...
#[doc = "Delta CTS. Set upon state change of input CTS. Cleared on a MSR read.\n\nValue on reset: 0"]
...
#[doc = "Delta DSR. Set upon state change of input DSR. Cleared on a MSR read.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DDSR_A {
...
#[doc = "Delta DCD. Set upon state change of input DCD. Cleared on a MSR read.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DDCD_A {
...
impl R {
    #[doc = "Bit 0 - Delta CTS. Set upon state change of input CTS. Cleared on a MSR read."]
    #[inline(always)]
    pub fn dcts(&self) -> DCTS_R {
        DCTS_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Delta DSR. Set upon state change of input DSR. Cleared on a MSR read."]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Delta DCD. Set upon state change of input DCD. Cleared on a MSR read."]
    #[inline(always)]

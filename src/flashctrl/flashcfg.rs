...
impl FLASHTIMR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            FLASHTIMR::_1_SYSTEM_CLOCK_FLASH => 1,
            FLASHTIMR::_2_SYSTEM_CLOCKS_FLAS => 2,
            FLASHTIMR::_3_SYSTEM_CLOCKS_FLAS => 3,
    ...
    pub fn _from(value: u8) -> FLASHTIMR {
        match value {
            1 => FLASHTIMR::_1_SYSTEM_CLOCK_FLASH,
            2 => FLASHTIMR::_2_SYSTEM_CLOCKS_FLAS,
            3 => FLASHTIMR::_3_SYSTEM_CLOCKS_FLAS,
...
impl FLASHTIMW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            FLASHTIMW::_1_SYSTEM_CLOCK_FLASH => 1,
            FLASHTIMW::_2_SYSTEM_CLOCKS_FLAS => 2,
            FLASHTIMW::_3_SYSTEM_CLOCKS_FLAS => 3,
        }
    }
}
#[doc = r" Proxy"]

...
impl From<FLASHTIM_A> for u8 {
    ...
    fn from(variant: FLASHTIM_A) -> Self {
        match variant {
            FLASHTIM_A::_1_SYSTEM_CLOCK_FLASH => 1,
            FLASHTIM_A::_2_SYSTEM_CLOCKS_FLAS => 2,
            FLASHTIM_A::_3_SYSTEM_CLOCKS_FLAS => 3,
        }
    }
}
...
impl FLASHTIM_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FLASHTIM_A> {
        use crate::Variant::*;
        match self.bits {
            1 => Val(FLASHTIM_A::_1_SYSTEM_CLOCK_FLASH),
            2 => Val(FLASHTIM_A::_2_SYSTEM_CLOCKS_FLAS),
            3 => Val(FLASHTIM_A::_3_SYSTEM_CLOCKS_FLAS),
            i => Res(i),
        }
    }

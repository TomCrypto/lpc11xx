#[doc = "Reader of register IOCON_SWCLK_PIO0_10"]
pub type R = crate::R<u32, super::IOCON_SWCLK_PIO0_10>;
#[doc = "Writer for register IOCON_SWCLK_PIO0_10"]
pub type W = crate::W<u32, super::IOCON_SWCLK_PIO0_10>;
#[doc = "Register IOCON_SWCLK_PIO0_10 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_SWCLK_PIO0_10 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function SWCLK"]
    SWCLK,
    #[doc = "1: Pin function PIO0_10"]
    PIO0_10,
    #[doc = "2: Pin function SCK0 (available depending on SCK location register)"]
    SCK0,
    #[doc = "3: Pin function CT16B0_MAT2"]
    CT16B0_MAT2,
}

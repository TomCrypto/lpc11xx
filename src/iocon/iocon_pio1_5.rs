#[doc = "Reader of register IOCON_PIO1_5"]
pub type R = crate::R<u32, super::IOCON_PIO1_5>;
#[doc = "Writer for register IOCON_PIO1_5"]
pub type W = crate::W<u32, super::IOCON_PIO1_5>;
#[doc = "Register IOCON_PIO1_5 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO1_5 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO1_5"]
    PIO1_5,
    #[doc = "1: Pin function RTS"]
    RTS,
    #[doc = "2: Pin function CT32B0_CAP0"]
    CT32B0_CAP0,
}

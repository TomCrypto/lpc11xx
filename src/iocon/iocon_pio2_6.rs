#[doc = "Reader of register IOCON_PIO2_6"]
pub type R = crate::R<u32, super::IOCON_PIO2_6>;
#[doc = "Writer for register IOCON_PIO2_6"]
pub type W = crate::W<u32, super::IOCON_PIO2_6>;
#[doc = "Register IOCON_PIO2_6 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_6 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_6"]
    PIO2_6,
    #[doc = "1: Pin function CT32B0_MAT1"]
    CT32B0_MAT1,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `PIO2_6`"]
    #[inline(always)]
    pub fn is_pio2_6(&self) -> bool {
        *self == FUNC_A::PIO2_6
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_6"]
    #[inline(always)]
    pub fn pio2_6(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_6)
    }
    #[doc = "Pin function CT32B0_MAT1"]
    #[inline(always)]

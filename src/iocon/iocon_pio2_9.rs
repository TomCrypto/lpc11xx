#[doc = "Reader of register IOCON_PIO2_9"]
pub type R = crate::R<u32, super::IOCON_PIO2_9>;
#[doc = "Writer for register IOCON_PIO2_9"]
pub type W = crate::W<u32, super::IOCON_PIO2_9>;
#[doc = "Register IOCON_PIO2_9 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_9 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_9"]
    PIO2_9,
    #[doc = "1: Pin function CT32B0_CAP0"]
    CT32B0_CAP0,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_9"]
    #[inline(always)]
    pub fn pio2_9(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_9)
    }

#[doc = "Reader of register IOCON_R_PIO0_11"]
pub type R = crate::R<u32, super::IOCON_R_PIO0_11>;
#[doc = "Writer for register IOCON_R_PIO0_11"]
pub type W = crate::W<u32, super::IOCON_R_PIO0_11>;
#[doc = "Register IOCON_R_PIO0_11 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_R_PIO0_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "1: Pin function PIO0_11"]
    PIO0_11,
    #[doc = "2: Pin function AD0"]
    AD0,
    #[doc = "3: Pin function CT32B0_MAT3"]
    CT32B0_MAT3,
}

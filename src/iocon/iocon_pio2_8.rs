#[doc = "Reader of register IOCON_PIO2_8"]
pub type R = crate::R<u32, super::IOCON_PIO2_8>;
#[doc = "Writer for register IOCON_PIO2_8"]
pub type W = crate::W<u32, super::IOCON_PIO2_8>;
#[doc = "Register IOCON_PIO2_8 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_8 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_8"]
    PIO2_8,
    #[doc = "1: Pin function CT32B0_MAT3"]
    CT32B0_MAT3,
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `PIO2_8`"]
    #[inline(always)]
    pub fn is_pio2_8(&self) -> bool {
        *self == FUNC_A::PIO2_8
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_8"]
    #[inline(always)]
    pub fn pio2_8(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_8)
    }
    #[doc = "Pin function CT32B0_MAT3"]
    #[inline(always)]

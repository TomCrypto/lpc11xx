#[doc = "Reader of register IOCON_PIO2_5"]
pub type R = crate::R<u32, super::IOCON_PIO2_5>;
#[doc = "Writer for register IOCON_PIO2_5"]
pub type W = crate::W<u32, super::IOCON_PIO2_5>;
#[doc = "Register IOCON_PIO2_5 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_5 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_5"]
    PIO2_5,
    #[doc = "1: Pin function CT32B0_MAT0"]
    CT32B0_MAT0,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `PIO2_5`"]
    #[inline(always)]
    pub fn is_pio2_5(&self) -> bool {
        *self == FUNC_A::PIO2_5
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_5"]
    #[inline(always)]
    pub fn pio2_5(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_5)
    }
    #[doc = "Pin function CT32B0_MAT0"]
    #[inline(always)]

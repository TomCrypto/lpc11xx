#[doc = "Reader of register IOCON_PIO2_11"]
pub type R = crate::R<u32, super::IOCON_PIO2_11>;
#[doc = "Writer for register IOCON_PIO2_11"]
pub type W = crate::W<u32, super::IOCON_PIO2_11>;
#[doc = "Register IOCON_PIO2_11 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_11"]
    PIO2_11,
    #[doc = "1: Pin function SCK0 (only if pin PIO2_11/SCK0 selected in Table 147)"]
    SELECT_FUNCTION_SCK0,
    #[doc = "2: Pin function CT32B0_CAP1"]
    CT32B0_CAP1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO2_11),
            1 => Val(FUNC_A::SELECT_FUNCTION_SCK0),
    ...
    #[doc = "Checks if the value of the field is `SELECT_FUNCTION_SCK0`"]
    #[inline(always)]
    pub fn is_select_function_sck0(&self) -> bool {
        *self == FUNC_A::SELECT_FUNCTION_SCK0
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_11"]
    #[inline(always)]
    pub fn pio2_11(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_11)
    }
    #[doc = "Pin function SCK0 (only if pin PIO2_11/SCK0 selected in Table 147)"]
    #[inline(always)]
    pub fn select_function_sck0(self) -> &'a mut W {
        self.variant(FUNC_A::SELECT_FUNCTION_SCK0)
    }
    #[doc = "Pin function CT32B0_CAP1"]
    #[inline(always)]

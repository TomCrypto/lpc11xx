#[doc = "Reader of register IOCON_PIO0_1"]
pub type R = crate::R<u32, super::IOCON_PIO0_1>;
#[doc = "Writer for register IOCON_PIO0_1"]
pub type W = crate::W<u32, super::IOCON_PIO0_1>;
#[doc = "Register IOCON_PIO0_1 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO0_1 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO0_1"]
    PIO0_1,
    #[doc = "1: Pin function CLKOUT"]
    CLKOUT,
    #[doc = "2: Pin function CT32B0_MAT2"]
    CT32B0_MAT2,
}

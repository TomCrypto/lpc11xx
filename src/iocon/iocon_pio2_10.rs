#[doc = "Reader of register IOCON_PIO2_10"]
pub type R = crate::R<u32, super::IOCON_PIO2_10>;
#[doc = "Writer for register IOCON_PIO2_10"]
pub type W = crate::W<u32, super::IOCON_PIO2_10>;
#[doc = "Register IOCON_PIO2_10 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_10 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO2_10),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `PIO2_10`"]
    #[inline(always)]
    pub fn is_pio2_10(&self) -> bool {
        *self == FUNC_A::PIO2_10
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_10"]
    #[inline(always)]
    pub fn pio2_10(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_10)
    }

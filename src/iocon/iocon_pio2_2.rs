#[doc = "Reader of register IOCON_PIO2_2"]
pub type R = crate::R<u32, super::IOCON_PIO2_2>;
#[doc = "Writer for register IOCON_PIO2_2"]
pub type W = crate::W<u32, super::IOCON_PIO2_2>;
#[doc = "Register IOCON_PIO2_2 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_2 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_2"]
    PIO2_2,
    #[doc = "1: Pin function DCD"]
    DCD,
    #[doc = "2: Pin function MISO1"]
    MISO1,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_2"]
    #[inline(always)]
    pub fn pio2_2(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_2)
    }

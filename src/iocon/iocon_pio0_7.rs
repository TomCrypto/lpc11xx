#[doc = "Reader of register IOCON_PIO0_7"]
pub type R = crate::R<u32, super::IOCON_PIO0_7>;
#[doc = "Writer for register IOCON_PIO0_7"]
pub type W = crate::W<u32, super::IOCON_PIO0_7>;
#[doc = "Register IOCON_PIO0_7 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO0_7 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO0_7"]
    PIO0_7,
    #[doc = "1: Pin function CTS"]
    CTS,
}

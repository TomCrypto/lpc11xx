#[doc = "Reader of register IOCON_PIO1_10"]
pub type R = crate::R<u32, super::IOCON_PIO1_10>;
#[doc = "Writer for register IOCON_PIO1_10"]
pub type W = crate::W<u32, super::IOCON_PIO1_10>;
#[doc = "Register IOCON_PIO1_10 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO1_10 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO1_10"]
    PIO1_10,
    #[doc = "1: Pin function AD6"]
    AD6,
    #[doc = "2: Pin function CT16B1_MAT1"]
    CT16B1_MAT1,
    #[doc = "3: Pin function MISO1"]
    MISO1,
}

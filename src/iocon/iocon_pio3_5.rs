#[doc = "Reader of register IOCON_PIO3_5"]
pub type R = crate::R<u32, super::IOCON_PIO3_5>;
#[doc = "Writer for register IOCON_PIO3_5"]
pub type W = crate::W<u32, super::IOCON_PIO3_5>;
#[doc = "Register IOCON_PIO3_5 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO3_5 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO3_5"]
    PIO3_5,
    #[doc = "1: Pin function CT16B1_CAP1"]
    CT16B1_CAP1,
    #[doc = "2: Pin function TXD"]
    TXD,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `PIO3_5`"]
    #[inline(always)]
    pub fn is_pio3_5(&self) -> bool {
        *self == FUNC_A::PIO3_5
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO3_5"]
    #[inline(always)]
    pub fn pio3_5(self) -> &'a mut W {
        self.variant(FUNC_A::PIO3_5)
    }
    #[doc = "Pin function CT16B1_CAP1"]
    #[inline(always)]
    pub fn ct16b1_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::CT16B1_CAP1)
    }
    #[doc = "Pin function TXD"]
    #[inline(always)]

#[doc = "Reader of register IOCON_PIO2_1"]
pub type R = crate::R<u32, super::IOCON_PIO2_1>;
#[doc = "Writer for register IOCON_PIO2_1"]
pub type W = crate::W<u32, super::IOCON_PIO2_1>;
#[doc = "Register IOCON_PIO2_1 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_1 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO2_1"]
    PIO2_1,
    #[doc = "1: Pin function DSR"]
    DSR,
    #[doc = "2: Pin function SCK1"]
    SCK1,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_1"]
    #[inline(always)]
    pub fn pio2_1(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_1)
    }

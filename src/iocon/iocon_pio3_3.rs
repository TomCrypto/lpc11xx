#[doc = "Reader of register IOCON_PIO3_3"]
pub type R = crate::R<u32, super::IOCON_PIO3_3>;
#[doc = "Writer for register IOCON_PIO3_3"]
pub type W = crate::W<u32, super::IOCON_PIO3_3>;
#[doc = "Register IOCON_PIO3_3 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO3_3 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO3_3"]
    PIO3_3,
    #[doc = "1: Pin function RI"]
    RI,
    #[doc = "2: Pin function CT16B0_CAP0"]
    CT16B0_CAP0,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO3_3"]
    #[inline(always)]
    pub fn pio3_3(self) -> &'a mut W {
        self.variant(FUNC_A::PIO3_3)
    }
    #[doc = "Pin function RI"]
    #[inline(always)]

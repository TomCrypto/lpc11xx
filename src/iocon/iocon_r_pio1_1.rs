#[doc = "Reader of register IOCON_R_PIO1_1"]
pub type R = crate::R<u32, super::IOCON_R_PIO1_1>;
#[doc = "Writer for register IOCON_R_PIO1_1"]
pub type W = crate::W<u32, super::IOCON_R_PIO1_1>;
#[doc = "Register IOCON_R_PIO1_1 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_R_PIO1_1 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "1: Pin function PIO1_1"]
    PIO1_1,
    #[doc = "2: Pin function AD2"]
    AD2,
    #[doc = "3: Pin function CT32B1_MAT0"]
    CT32B1_MAT0,
}

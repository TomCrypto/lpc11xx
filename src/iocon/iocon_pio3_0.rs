#[doc = "Reader of register IOCON_PIO3_0"]
pub type R = crate::R<u32, super::IOCON_PIO3_0>;
#[doc = "Writer for register IOCON_PIO3_0"]
pub type W = crate::W<u32, super::IOCON_PIO3_0>;
#[doc = "Register IOCON_PIO3_0 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO3_0 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO3_0"]
    PIO3_0,
    #[doc = "1: Pin function DTR"]
    DTR,
    #[doc = "2: Pin function CT16B0_MAT0"]
    CT16B0_MAT0,
    #[doc = "3: Pin function TXD"]
    TXD,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `PIO3_0`"]
    #[inline(always)]
    pub fn is_pio3_0(&self) -> bool {
        *self == FUNC_A::PIO3_0
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO3_0"]
    #[inline(always)]
    pub fn pio3_0(self) -> &'a mut W {
        self.variant(FUNC_A::PIO3_0)
    }

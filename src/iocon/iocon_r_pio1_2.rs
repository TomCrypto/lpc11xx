#[doc = "Reader of register IOCON_R_PIO1_2"]
pub type R = crate::R<u32, super::IOCON_R_PIO1_2>;
#[doc = "Writer for register IOCON_R_PIO1_2"]
pub type W = crate::W<u32, super::IOCON_R_PIO1_2>;
#[doc = "Register IOCON_R_PIO1_2 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_R_PIO1_2 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "1: Pin function PIO1_2"]
    PIO1_2,
    #[doc = "2: Pin function AD3"]
    AD3,
    #[doc = "3: Pin function CT32B1_MAT1"]
    CT32B1_MAT1,
}

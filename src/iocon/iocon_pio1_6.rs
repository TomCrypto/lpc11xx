#[doc = "Reader of register IOCON_PIO1_6"]
pub type R = crate::R<u32, super::IOCON_PIO1_6>;
#[doc = "Writer for register IOCON_PIO1_6"]
pub type W = crate::W<u32, super::IOCON_PIO1_6>;
#[doc = "Register IOCON_PIO1_6 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO1_6 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO1_6"]
    PIO1_6,
    #[doc = "1: Pin function RXD"]
    RXD,
    #[doc = "2: Pin function CT32B0_MAT0"]
    CT32B0_MAT0,
}

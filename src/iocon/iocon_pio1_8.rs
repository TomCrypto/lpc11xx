#[doc = "Reader of register IOCON_PIO1_8"]
pub type R = crate::R<u32, super::IOCON_PIO1_8>;
#[doc = "Writer for register IOCON_PIO1_8"]
pub type W = crate::W<u32, super::IOCON_PIO1_8>;
#[doc = "Register IOCON_PIO1_8 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO1_8 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO1_8"]
    PIO1_8,
    #[doc = "1: Pin function CT16B1_CAP0"]
    CT16B1_CAP0,
}

#[doc = "Reader of register IOCON_PIO1_4"]
pub type R = crate::R<u32, super::IOCON_PIO1_4>;
#[doc = "Writer for register IOCON_PIO1_4"]
pub type W = crate::W<u32, super::IOCON_PIO1_4>;
#[doc = "Register IOCON_PIO1_4 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO1_4 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function. This pin functions as WAKEUP pin if the LPC111x/LPC11Cxx is in Deep power-down mode regardless of the value of FUNC. All other values are reserved.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FUNC_A {
    #[doc = "0: Pin function PIO1_4"]
    PIO1_4,
    #[doc = "1: Pin function AD5"]
    AD5,
    #[doc = "2: Pin function CT32B1_MAT3"]
    CT32B1_MAT3,
}
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function. This pin functions as WAKEUP pin if the LPC111x/LPC11Cxx is in Deep power-down mode regardless of the value of FUNC. All other values are reserved."]
    #[inline(always)]

#[doc = "Reader of register IOCON_PIO3_4"]
pub type R = crate::R<u32, super::IOCON_PIO3_4>;
#[doc = "Writer for register IOCON_PIO3_4"]
pub type W = crate::W<u32, super::IOCON_PIO3_4>;
#[doc = "Register IOCON_PIO3_4 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO3_4 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO3_4"]
    PIO3_4,
    #[doc = "1: Pin function CT16B0_CAP1"]
    CT16B0_CAP1,
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO3_4"]
    #[inline(always)]
    pub fn pio3_4(self) -> &'a mut W {
        self.variant(FUNC_A::PIO3_4)
    }
    #[doc = "Pin function CT16B0_CAP1"]
    #[inline(always)]

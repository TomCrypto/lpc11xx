#[doc = "Reader of register IOCON_PIO3_2"]
pub type R = crate::R<u32, super::IOCON_PIO3_2>;
#[doc = "Writer for register IOCON_PIO3_2"]
pub type W = crate::W<u32, super::IOCON_PIO3_2>;
#[doc = "Register IOCON_PIO3_2 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO3_2 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO3_2"]
    PIO3_2,
    #[doc = "1: Pin function DCD"]
    DCD,
    #[doc = "2: Pin function CT16B0_MAT2"]
    CT16B0_MAT2,
    #[doc = "3: Pin function SCK1"]
    SCK1,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO3_2"]
    #[inline(always)]
    pub fn pio3_2(self) -> &'a mut W {
        self.variant(FUNC_A::PIO3_2)
    }
    #[doc = "Pin function DCD"]
    #[inline(always)]

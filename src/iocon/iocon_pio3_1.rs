#[doc = "Reader of register IOCON_PIO3_1"]
pub type R = crate::R<u32, super::IOCON_PIO3_1>;
#[doc = "Writer for register IOCON_PIO3_1"]
pub type W = crate::W<u32, super::IOCON_PIO3_1>;
#[doc = "Register IOCON_PIO3_1 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO3_1 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO3_1"]
    PIO3_1,
    #[doc = "1: Pin function DSR"]
    DSR,
    #[doc = "2: Pin function CT16B0_MAT1"]
    CT16B0_MAT1,
    #[doc = "3: Pin function RXD"]
    RXD,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO3_1"]
    #[inline(always)]
    pub fn pio3_1(self) -> &'a mut W {
        self.variant(FUNC_A::PIO3_1)
    }
    #[doc = "Pin function DSR"]
    #[inline(always)]
    pub fn dsr(self) -> &'a mut W {
        self.variant(FUNC_A::DSR)
    }
    #[doc = "Pin function CT16B0_MAT1"]
    #[inline(always)]

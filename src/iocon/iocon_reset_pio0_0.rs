#[doc = "Reader of register IOCON_RESET_PIO0_0"]
pub type R = crate::R<u32, super::IOCON_RESET_PIO0_0>;
#[doc = "Writer for register IOCON_RESET_PIO0_0"]
pub type W = crate::W<u32, super::IOCON_RESET_PIO0_0>;
#[doc = "Register IOCON_RESET_PIO0_0 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_RESET_PIO0_0 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function RESET"]
    RESET,
    #[doc = "1: Pin function PIO0_0"]
    PIO0_0,
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function RESET"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(FUNC_A::RESET)
    }
    #[doc = "Pin function PIO0_0"]
    #[inline(always)]

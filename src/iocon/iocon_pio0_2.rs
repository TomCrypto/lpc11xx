#[doc = "Reader of register IOCON_PIO0_2"]
pub type R = crate::R<u32, super::IOCON_PIO0_2>;
#[doc = "Writer for register IOCON_PIO0_2"]
pub type W = crate::W<u32, super::IOCON_PIO0_2>;
#[doc = "Register IOCON_PIO0_2 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO0_2 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO0_2"]
    PIO0_2,
    #[doc = "1: Pin function SSEL0"]
    SSEL0,

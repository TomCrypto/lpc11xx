#[doc = "Reader of register IOCON_PIO2_3"]
pub type R = crate::R<u32, super::IOCON_PIO2_3>;
#[doc = "Writer for register IOCON_PIO2_3"]
pub type W = crate::W<u32, super::IOCON_PIO2_3>;
#[doc = "Register IOCON_PIO2_3 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO2_3 {
    type Type = u32;
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Pin function PIO2_3"]
    #[inline(always)]
    pub fn pio2_3(self) -> &'a mut W {
        self.variant(FUNC_A::PIO2_3)
    }
    #[doc = "Pin function RI"]
    #[inline(always)]

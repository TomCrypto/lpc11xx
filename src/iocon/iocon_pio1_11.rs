#[doc = "Reader of register IOCON_PIO1_11"]
pub type R = crate::R<u32, super::IOCON_PIO1_11>;
#[doc = "Writer for register IOCON_PIO1_11"]
pub type W = crate::W<u32, super::IOCON_PIO1_11>;
#[doc = "Register IOCON_PIO1_11 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO1_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum FUNC_A {
    #[doc = "0: Pin function PIO1_11"]
    PIO1_11,
    #[doc = "1: Pin function AD7"]
    AD7,
    #[doc = "2: Pin function CT32B1_CAP1"]
    CT32B1_CAP1,
}

#[doc = "Reader of register IOCON_PIO0_3"]
pub type R = crate::R<u32, super::IOCON_PIO0_3>;
#[doc = "Writer for register IOCON_PIO0_3"]
pub type W = crate::W<u32, super::IOCON_PIO0_3>;
#[doc = "Register IOCON_PIO0_3 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::IOCON_PIO0_3 {
    type Type = u32;
    #[inline(always)]

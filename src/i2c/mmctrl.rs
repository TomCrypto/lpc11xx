...
impl From<MM_ENA_A> for bool {
    ...
    fn from(variant: MM_ENA_A) -> Self {
        match variant {
            ...
            MM_ENA_A::THE_I2C_MODULE_WILL_ => true,
        }
    }
}
...
impl MM_ENA_R {
    ...
    pub fn variant(&self) -> MM_ENA_A {
        match self.bits {
            ...
            true => MM_ENA_A::THE_I2C_MODULE_WILL_,
        }
    }
    ...
    pub fn is_the_i2c_module_will_(&self) -> bool {
        *self == MM_ENA_A::THE_I2C_MODULE_WILL_
    }
}
...
impl<'a> MM_ENA_W<'a> {
    ...
    pub fn the_i2c_module_will_(self) -> &'a mut W {
        self.variant(MM_ENA_A::THE_I2C_MODULE_WILL_)
    }
...
pub enum ENA_SCL_A {
    ...
    HIGH,
    #[doc = "1: When this bit is set, the I2C module may exercise the same control over the clock line that it would in normal operation. This means that, acting as a slave peripheral, the I2C module can stretch the clock line (hold it low) until it has had time to respond to an I2C interrupt."]
    NORMAL,
}
